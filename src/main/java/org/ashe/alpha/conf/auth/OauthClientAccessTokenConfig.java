...
import org.ashe.alpha.domain.vo.UserInfoVO;
        ...
        return (accessToken, authentication) -> {
            ...
            if (userAuthentication instanceof UsernamePasswordAuthenticationToken) {
                ...
                if (principal instanceof OauthUserDetails) {
                    OauthUserDetails userDetails = (OauthUserDetails) token.getPrincipal();
                    UserInfoVO userInfoVO = new UserInfoVO();
                    BeanUtils.copyProperties(userDetails.getUser(), userInfoVO);
                    information.put("user_info", userInfoVO);
